    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map(uni => (
            <Link key={uni.id} to={`/university/${uni.id}`} className="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all hover:-translate-y-1 overflow-hidden group">
              ...
              <div className="p-5">
                ...
                <div className="grid grid-cols-3 gap-2 pt-3 border-t border-gray-100 text-center">
                  <div>
                    <p className="font-bold text-gray-900 text-sm">{uni.courses.length}</p>
                  ...
                  <div>
                    <p className="font-bold text-blue-700 text-sm">{uni.averageFees.currency} {(uni.averageFees.postgraduate / 1000).toFixed(0)}k</p>
